print("-----------------------------------------{SELAMAT DATANG DI PEMESANAN PIZZAQU}-----------------------------------------")
pizza = input("Masukan Namamu : ")
pizzahut5 = int(input("Pastikan pesananmu sesuai dengan keinginan hatimu\nsilahkan ulangi pesananmu, jika ada kesalahan saat memilih pilihanmu\nketik 1 untuk lanjut, ketik 2 untuk berhenti\n: "))
